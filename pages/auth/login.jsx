              ...
              <div className="m-4 col-11 col-md-4 card">
                <form onSubmit={handleSubmit} method="post">
                  <div className="ps-form--review">
                    <h2 className="ps-form__title">Sign in to your Profile</h2>
                    <div className="m-3">
                      {message !== "" && (
                        <Alert
                          message={message}
                    ...
                    <div className="ps-form__submit">
                      {loading ? (
                        <button className="ps-btn ps-btn--gray" disabled>
                          <span
                    ...
                    <a className="ps-account__link" href="lost-password.html">
                      Lost your password?
                    </a>
                  </div>
                </form>

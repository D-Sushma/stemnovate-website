...
const MyAccountScreen = () => {
    ...
    const Submitform = async (event) => {
        ...
        if (Password == ConPassword) {
            if (TandC !== "") {
                if (FirstName != "" && Email != "" && Location !== "" && Password !== "" && ConPassword !== "") {
                    try {
                        ...
                        <div className="row">
                            <div className="container" style={{ maxWidth: "960px" }}>
                                <div className="m-4 col-12 col-md-12 ">
                                    ...
                                    <p className="mb-4">Welcome. Creating an online profile will allow you personalize your shipping and billing information and provides you prices that are specific to you and the organization you work in. Do you already have an account? Sign In</p>
                                    {message != "" ? <Alert message="Warning" description={message} type="warning" showIcon closable /> : null}
                                        ...
                                        <div className="ps-form--review">
                                            ...
                                            <div className="form-row">
                                                    ...
                                                    <div className="ps-form__group">
                                                        ...
                                                        <div className="input-group">
                                                            ...
                                                            <div
                                                                ...
                                                                <a className={showpass ? "fa fa-eye toogle-password" : "fa fa-eye-slash toogle-password"}></a>
                                                            </div>
                                                        </div>
                                                        {passwordwarnig != "" ? <p className="text-danger">{passwordwarnig}</p> : null}
                                                    </div>
                                                </div>
                                                <div className="form-group col-md-6">
                                                    <div className="ps-form__group">
                                                ...
                                                <div className="col-md-12 col-12">
                                                    ...
                                                    <div className="form-group">
                                                        <div className="form-check">
                                                            <input
                                                                ...
                                                                required
                                                            />
                                                            <label className={TandC ? " form-check-label " : "form-check-label  text-danger"} htmlFor="toc">
                                                    ...
                                                    <p>This information will not be collected for promotional purposes. For more, read our Privacy Policy.</p>
                                                </div>
                                                <div className="mt-5 form-group col-md-3">
                                                    <div className="ps-form__submit">
                                                        <button className="ps-btn--lg ps-btn--curve ps-btn--fullwidth ps-btn--warning">Cancel</button>
                                                    </div>
                                                </div>
                                                <div className="mt-5 form-group col-md-3">
                                                    <div className="ps-form__submit">
                                                        <button className="ps-btn--lg ps-btn--curve ps-btn--fullwidth ps-btn--orange ">Create Profile</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

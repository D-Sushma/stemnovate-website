...
const Blogs = () => {
    ...
    return (
        <Container title="How a CYP of Coffee understand precision medicine" ogimg="https://stemnovate.co.uk/static/img/Blog/4.jpg">
                        ...
                        <div className="">
                                ...
                                <section className="ps-section--block-grid ">
                                    <div className="ps-section__thumbnail">
                                        <a className="ps-section__image" href="#">
                                            <img src="/static/img/Blog/4.jpg" alt="understand precision medicine" />
                                        </a>
                                    </div>
                                    <div className="ps-section__content">
                                        <div className="ps-section__desc">
                                            <h1>How a ‘CYP of Coffee’ can help us to understand precision medicine.</h1>
                                        </div>
                                        <div className="row">
                                            ...
                                            <div className="col-md-5">
                                                <FacebookShareButton url={url} quote={"How a ‘CYP of Coffee’ can help us to understand precision medicine."} hashtag={"#Stemnovate"}>
                                                    <FacebookIcon size={42} round />
                                                </FacebookShareButton>
                                                <TwitterShareButton url={url} quote={"How a ‘CYP of Coffee’ can help us to understand precision medicine."} hashtag={"#Stemnovate"}>
                                                    <TwitterIcon size={42} round />
                                                </TwitterShareButton>
                                                <LinkedinShareButton url={url} quote={"How a ‘CYP of Coffee’ can help us to understand precision medicine."} hashtag={"#Stemnovate"}>
                                                    <LinkedinIcon size={42} round />
                                                </LinkedinShareButton>
                                                <WhatsappShareButton url={url} quote={"How a ‘CYP of Coffee’ can help us to understand precision medicine."} hashtag={"#Stemnovate"}>
                            ...
                            <div className="container">
                                <div className="center-box">
                                    <p className=" vertical-center">A few days back I met a friend in Cambridge city Centre and the delicious aroma of brewing coffee led us into a popular local café. The place was bustling with people, sitting around chatting and enjoying their coffees.</p>
                                    <br />
                                    <p className=" vertical-center">When our respective cuppas arrived, my friend announced: “You should drink your coffee black!” “I would if I could, but my CYPs are different to yours’’, I replied, somewhat defensively. ‘“Sip slow and you’ll get used to it”, she told me.</p>
                                    <br />
                                    <p className=" vertical-center">The ‘CYPs’ I’m referring to are the Cytochrome P450 enzymes that metabolize the caffeine in coffee, and I must admit to having something of a poor tolerance to caffeine.</p>
                                    <br />
                                    <p className=" vertical-center">Coffee is the most popular drink in the world with over 400 billion cups consumed every year. Caffeine (1,3,7-trimethylxanthine) is a psychoactive substance that is metabolized by the enzyme Cytochrome P450 type1A2 (CYP1A2)1. In a study involving 40,000 individuals, this enzyme was found to determine caffeine intake.</p>
                                    <br />
                                    <p className=" vertical-center">Drug metabolism primarily occurs in the liver, where the lipid soluble compounds are converted to water-soluble compounds, facilitating detoxification and excretion. Cytochrome P450 enzymes are the prime catalysts in this process.</p>
                                    <br />

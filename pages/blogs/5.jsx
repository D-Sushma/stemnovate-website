...
const Blogs = () => {
    ...
    return (
        <Container title="Stemnovate in Anglia Ruskin University" ogimg="https://stemnovate.co.uk/static/img/Blog/5.jpg">
                        ...
                        <div className="">
                                ...
                                <section className="ps-section--block-grid ">
                                    <div className="ps-section__thumbnail">
                                        <a className="ps-section__image" href="#">
                                            <img src="/static/img/Blog/blog5.jpg" alt="Stemnovate - support young scientists" />
                                        </a>
                                    </div>
                                    <div className="ps-section__content">
                                        <div className="ps-section__desc">
                                            <h1>Stemnovate´s visit to Anglia Ruskin University to support young scientists.</h1>
                                        </div>
                                        <div className="row">
                                            ...
                                            <div className="col-md-5">
                                                <FacebookShareButton url={url} quote={"Stemnovate´s visit to Anglia Ruskin University to support young scientists."} hashtag={"#Stemnovate"}>
                                                    <FacebookIcon size={42} round />
                                                </FacebookShareButton>
                                                <TwitterShareButton url={url} quote={"Stemnovate´s visit to Anglia Ruskin University to support young scientists."} hashtag={"#Stemnovate"}>
                                                    <TwitterIcon size={42} round />
                                                </TwitterShareButton>
                                                <LinkedinShareButton url={url} quote={"Stemnovate´s visit to Anglia Ruskin University to support young scientists."} hashtag={"#Stemnovate"}>
                                                    <LinkedinIcon size={42} round />
                                                </LinkedinShareButton>
                                                <WhatsappShareButton url={url} quote={"Stemnovate´s visit to Anglia Ruskin University to support young scientists."} hashtag={"#Stemnovate"}>
                            ...
                            <div className="container">
                                <div className="center-box">
                                    <p className=" vertical-center">Stemnovate ́s core value is to promote STEM education and professional development for the younger generations, with this in mind we partnered with @AngliRuskinuniversity for two live briefs which consisted of assigning students a real word task and for them to create solutions and ideas that benefit the society. The undergraduate student in microbiology created content and educational resources for Covid 19 assays and disease, this aimed to overcome the problem of misinformation around the disease andcreating new assays that are more accurate for rapid molecular diagnostics. (tag Ben, director, media team).</p>
                                    <br />
                                    <p className=" vertical-center">We are glad we had the opportunity to collaborate with @AngliaRuskin to disseminate knowledge to young students, give them an overview of how the industry works, and communicate knowledge efficiently to the rest of the world.</p>
                                    <br />
                                    <p className=" vertical-center">Stemnovate has worked closely for over two years with Anglia Ruskin building bridges between young scientists and scientific industries, helping them to develop transferable skills and scientific knowledge that would benefit them in future employment, and to gain experience in the industry working along with experts, PhDs and MDs. We will also give them experience in marketing, selling strategy and an overview of the real-life application of molecular diagnostics techniques.</p>
                                    <br />
                                    <p className=" vertical-center">We appreciate the students that created educational resources with information about Covid 19. We would like to congratulate you on your hard work. Your ideas were very much appreciated. Knowledge about Covid 19 is vital for adopting protective behaviours and measures against Covid 19 that help fight the spread and save lives.</p>
                                    <br />
                                    <p className=" vertical-center">We are sharing some of the great work produced by the students and we look forward to continuing working on future projects with @ARU.</p>
                                    <br />
                                    {/*                                     

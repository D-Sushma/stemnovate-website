...
const Blogs = () => {
    ...
    return (
        <Container title="The creation of new scalable manufacturing process" ogimg="https://stemnovate.co.uk/static/img/Blog/2.jpg">
                                ...
                                <section className="ps-section--block-grid ">
                                    ...
                                    <div className="ps-section__content">
                                        <div className="ps-section__desc">
                                            <h1>The creation of new scalable manufacturing process</h1>
                                        </div>
                                        <div className="row">
                                            ...
                                            <div className="col-md-5">
                                                <FacebookShareButton url={url} quote={"The creation of new scalable manufacturing process."} hashtag={"#Stemnovate"}>
                                                    <FacebookIcon size={42} round />
                                                </FacebookShareButton>
                                                <TwitterShareButton url={url} quote={"The creation of new scalable manufacturing process."} hashtag={"#Stemnovate"}>
                                                    <TwitterIcon size={42} round />
                                                </TwitterShareButton>
                                                <LinkedinShareButton url={url} quote={"The creation of new scalable manufacturing process."} hashtag={"#Stemnovate"}>
                                                    <LinkedinIcon size={42} round />
                                                </LinkedinShareButton>
                                                <WhatsappShareButton url={url} quote={"The creation of new scalable manufacturing process."} hashtag={"#Stemnovate"}>

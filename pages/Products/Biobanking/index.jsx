...
const categoryListScreen = () => {
    ...
    return (
        <>
            <Container title="Biobanking" description={"Stemnovate has the world’s first commercial biobank for human iPS cells with complete genotype information"}>
                <main className="ps-page ps-page--inner">
                    <div className="ps-page__header  breadcrumb-h product-breadcrumb-bg">
                        <div className="container ">
                            <BreadCrumb breacrumb={breadcrumb} /> <h1 className="text-center  text-white p-2">BIOBANKING</h1>
                        </div>
                    </div>
                                        ...
                                        <div className="col-md-6 text-center">
                                            <div>
                                                ...
                                                <p className="mx-4 text-left ">
                                                    ...
                                                    from the Office of women’s health (OWH), Food and Drug Administration (FDA), women experience more adverse reactions to treatment with therapeutic drugs than men because of differences in drug metabolism. Stemnovate biobank addresses the lack of gender diversity with a robust collection of female primary cells and induced pluripotent stem cell lines. Using cells from a more diverse sample selection can help to see the differences in drug metabolism and individual variability in clinical response.
                                                </p>
                                            </div>
                                        </div>
                                    </div>

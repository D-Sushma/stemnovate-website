...
const texicologyScreen = () => {
    ...
    return (
        <Container title="rapid diagnostics and new diagnosis assay products" description={`Stemnovate has rapid diagnostics and new diagnosis assay products and we are developing a product for the early diagnosis of heart conditions as well`}>
                        ...
                        <div className=" about-section ">
                            <div className="container">
                                <div className="center-box">
                                    <p className=" vertical-center">At Stemnovate, we integrate advanced bioinformatics with our cellular platform to identify biomarkers that can help diagnose liver and heart diseases or neurodegenerative diseases early.</p>
                                </div>
                            </div>
                        </div>

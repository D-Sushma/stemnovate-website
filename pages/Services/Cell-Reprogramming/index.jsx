...
const texicologyScreen = () => {
  ...
  return (
    <Container
      ...
      description={`Stemnovate offers custom reprogramming services, saving you the time which can be better spent performing valuable research`}
    >
                  ...
                  <div className="ps-section__content ">
                    <div className="ps-section__desc ">
                      ...
                      <p className="text-white ">
                        ...
                        cellular identity to produce a therapeutically valuable
                        cell type. The potential to grow and maintain any cell
                        type of interest has excellent clinical value, creating
                        the opportunity to develop a scalable and functional
                        cell source for ex vivo cell therapy development, and
                        explore novel therapeutic modalities. Unfortunately,
                        generating induced pluripotent stem cells can often be a
                        costly and time-consuming process.
                        <br />
                        Stemnovate offers custom reprogramming services, saving
                        you the time which can be better spent performing
                        valuable research experiments.
                      </p>
                    </div>
                  </div>
                </section>

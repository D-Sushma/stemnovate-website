                        ...
                        <div className="ps-about">
                            <div className=" about-section ">
                                <div className="container center-box">
                                    <p className="vertical-center">Stemnovate provides whole genome transcriptomics as a service. This invaluable tool provides an unprecedented coverage and depth into the transcriptional regulation of cells. The platform utilises high accuracy for both long and short reads. We provide bioinformatics to reveal gene signalling networks and novel transcript signalling pathways.</p>
                                </div>
                            </div>
                                    ...
                                    <section className="ps-section--block-grid ">
                                        <div className="ps-section__thumbnail">
                                            <a className="ps-section__image" href="#">
                                                <img className="ps-banner__image" src="/static/img/services/Sequencing.webp" alt="Whole transcriptomics" />
                                            </a>
                                        </div>
                                            ...
                                            <div className="ps-section__desc ">
                                                <div className="center-box">
                                                    <div className="vertical-center">
                                                        <h3 className="text-white font-weight-bold text-uppercase">Whole transcriptomics</h3>
                                                        <p className="text-white ">
                                                            ...
                                                            <ol>
                                                                <li>
                                                                    <p>1. Exome analysis for nucleotide sequence capture and quantitative gene expression.</p>
                                                                </li>
                                                                <li>
                                                                    <p>2. Metatranscriptomics study for species identification and taxonomic classification and microbe quantification.</p>
                                                                </li>
                                                                <li>
                                                                    <p>3. Discovery of novel Biomarkers inferred from in-depth bioinformatic analysis and computational modeling.</p>
                                                                </li>
                                                                <li>
                                                                    <p>4. Chromosomal -loci gene expression report and human gender identification.</p>
                                                                </li>
                                                            </ol>
                                                        </p>
                                                    </div>
                            ...
                            <div className=" about-section">
                                <div className="container">
                                    <section className="ps-section--block-grid ">
                                        <div className="ps-section__thumbnail">
                                            <a className="ps-section__image" href="#">
                                                <img className="ps-banner__image" src="/static/img/services/Bioinformatics.jpg" alt="BIOINFORMATICS" />
                                            </a>
                                        </div>
                                        <div className="ps-section__content ">
                                            <div className="ps-section__desc ">
                                                <div className="center-box">
                                                    <div className="vertical-center">
                                                        <h3 className=" font-weight-bold text-uppercase">BIOINFORMATICS</h3>
                                                        <p className=" ">
                                                            ...
                                                            <ol>
                                                                <li>
                                                                    <p>1. Computational modeling for co-expression and fusion -fission events.</p>
                                                                </li>
                                                                <li>
                            ...
                            <div className=" about-section">
                                <div className="container">
                                    <section className="ps-section--block-grid ">
                                        <div className="ps-section__thumbnail">
                                            <a className="ps-section__image" href="#">
                                                <img src="/static/img/services/Genotyping.jpg" alt="Genotyping" />
                                            </a>
                                        </div>
                                        <div className="ps-section__content ">
                                            <div className="ps-section__desc ">
                                                <div className="center-box">
                                                    <div className="vertical-center">
                                                        <h3 className=" font-weight-bold">How Genotyping influences Drug Discovery?</h3>
                                                        <p className="">
                                                            ...
                                                            <Tooltip title="Cytochrome P450 2D6: overview and update on pharmacology, genetics, biochemistry - PubMed (nih.gov)">
                                                                <a rel="noreferrer" className="reference-website" target={"_blank"} href="https://pubmed.ncbi.nlm.nih.gov/14618296/">

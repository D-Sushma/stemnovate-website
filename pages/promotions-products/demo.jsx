                        ...
                        <div className="ps-banner__block">
                          <div className="ps-banner__content d-flex  justify-content-between">
                            <div className="d-flex flex-column ">
                              <div className="ps-banner__desc ">
                                We have some fantastic promotions!
                              </div>
                              <div className="ps-banner__desc ">
                                {" "}
                                Get up to 10% OFF on Live Human Fibroblasts!
                              </div>
                              <div className="ps-banner__desc ">
                                Don't miss out on these enormous savings!
                              </div>
                            </div>
                            <div className="d-flex flex-column">
                              ...
                              <div>
                                <a
                                  ...
                                  href="/promotions-products/offers"
                                >
                                  Shop Now
                                </a>
                              </div>
                          ...
                          <div className="ps-banner__thumnail ps-banner__fluid">
                            <img
                              ...
                              src="/static/img/icon/promotion-one.webp"
                              alt="alt"
                            />
                          </div>
                        </div>
                        ...
                        <div className="ps-banner__block">
                          <div className="ps-banner__content d-flex  justify-content-between">
                            <div className="d-flex flex-column gap-3">
                              <div className="ps-banner__desc ">
                                You can win an Amazon voucher for sharing
                                pictures of your work.
                              </div>
                              <p className="h1">
                                {" "}
                                Take a picture of your project using
                                Stemnovate´s cells or media and join our
                                competition to get the chance to win an Amazon
                                voucher and a prime space on our website!
                              </p>
                              <br />{" "}
                              <p className="h1">
                                We have taken and shared incredible pictures of
                                cells in our lab. Now, we would like to see
                                yours!
                              </p>
                              {/* </div>
                                        <div className="d-flex flex-column"> */}
                          ...
                          <div className="ps-banner__thumnail ps-banner__fluid">
                            <img
                              className="ps-banner__image"
                              src="/static/img/icon/promo-bg.svg"
                              alt="alt"
                            />
                          </div>
                        </div>

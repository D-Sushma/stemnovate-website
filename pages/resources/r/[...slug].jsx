...
import { FaArrowRight, FaRegArrowAltCircleDown, FaRegArrowAltCircleUp } from "react-icons/fa";
...
const ResourcesData = (props) => {
    ...
    const getRelatedResources = async () => {
        ...
        const res = await fetch(baseUrl + "/api/resources/access/getRelatedResources", requestOptions);
            ...
            <main className="ps-page ps-page--inner">
                <div className="ps-page__header  breadcrumb-h application-breadcrumb-bg">
                    <div className="container ">
                        ...
                        <h1 className="text-center  text-white p-2">{resourcesData.data[0].cat_name ? resourcesData.data[0].cat_name : slug}</h1>
                    </div>
                </div>
                ...
                <div className="ps-page__content">
                    <div className="ps-about">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-md-6 my-2">
                                        <img src={`${process.env.AWS_S3BUCKET_URL}${resourcesData.data[0].category_image}`} className="rounded" alt={resourcesData.data[0].cat_name} />
                                    </div>
                                    ...
                                    <div className="col-md-6 my-2">
                                        ...
                                        <div className="download-option d-none">
                                            ...
                                            <p>Downloads - 2681</p>
                                            <div className="my-3">
                                                <button className="button button--green mr-2">Download</button>
                                                <button className="button button--yellow ">Go Premium</button>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    {readMore ? (
                                        ...
                                        <div
                                            className="text-left"
                                            dangerouslySetInnerHTML={{
                                                __html: resourcesData.data[0].category_content.length > 500 ? resourcesData.data[0].category_content.substring(0, 500) + "..." : resourcesData.data[0].category_content,
                                            }}
                                        />
                                    )}
                                    {resourcesData.data[0].category_content && resourcesData.data[0].category_content.length > 499 ? (
                                        <div className="text-center m-3">
                                            <button>
                                                <p className="text-orange" onClick={() => setReadMore(!readMore)}>
                                                    {!readMore ? <FaRegArrowAltCircleDown /> : <FaRegArrowAltCircleUp />} {readMore ? "Show less" : "Show More"}
                                                </p>
                                            </button>
                                        </div>
                                    ) : null}
                                ...
                                <div className="container">
                                    <div className="row ">
                                        ...
                                        {resourcesFiles.map((myRes, index) => (
                                            <div className="col-md-3 my-6 col-sm-3 col-6 d-flex flex-column flex-grow-1" key={index}>
                                                <div className="card  d-flex flex-column flex-grow-1 rounded-lg align-items-center p-0 ">
                                                    <img src={`${process.env.AWS_S3BUCKET_URL}${myRes.resources_preview}`} className="rounded" alt={myRes.resources_name} />
                                                    <div className="card-body p-0 container-fluid">
                                                        <div className="p-3">
                                                            ...
                                                            {myRes.resources_price > 0 ? <span className="badge badge-pill badge-primary">Member only</span> : <span className="badge badge-pill badge-success">Free</span>}
                                                            {myRes.resources_content !== "null" ? (
                                                                <p
                                                                    className=" bd-highlight mt-3 "
                                                                    style={{ minHeight: "50px" }}
                                                                    dangerouslySetInnerHTML={{
                                                                        __html: myRes.resources_content.substr(0, 100),
                                                                    }}></p>
                                                            ) : null}
                                                            <Link href={`/resources/details/${resourcesData.data[0].slug}/${myRes.resources_id}/${myRes.access_type}`}>
                        ...
                        {resourcesData.data[0] && resourcesData.data[0].other_resources_category.length > 0 ? (
                            <div className="about-section pt-3">
                                <div className="container">
                                    <div className="row ">
                                        <div className="col-md-12">
                                        ...
                                        {resourcesData.data[0].other_resources_category.map((myCat, index) => (
                                            <div className="col-md-3 my-6 col-sm-3 col-6 d-flex flex-column flex-grow-1" key={index}>
                                                    ...
                                                    <div className="card  d-flex flex-column flex-grow-1 rounded-lg align-items-center p-0 ">
                                                        ...
                                                        <div className="card-body p-0 container-fluid">
                                                            <div className="p-3">
                                                                ...
                                                                {myCat.cat_access ? <span className="badge badge-pill badge-primary">Member only</span> : <span className="badge badge-pill badge-success">Free</span>}
...
export async function getServerSideProps({ query }) {
    ...
    if (slug != undefined) {
        ...
        const res = await fetch(baseUrl + "/api/resources/getResourcesBySlug", requestOptions);

                ...
                <div className="ps-page__content">
                    <div className="container">
                        <div className="ps-about">
                            <div className="container">
                                <p className="py-4 font-weight-bold">Hello, {UserData && UserData.result.firstname + " " + UserData.result.lastname}</p>
                                            ...
                                            <Card className="card-bg-color m-2 " hoverable bordered>
                                                <div className="d-flex justify-content-between flex-row">
                                                    ...
                                                    <div className="d-flex flex-column align-items-center m-2">
                                                        <h4 className="align-self-start mb-1">Edit Profile</h4>
                                        ...
                                        <Link href={"/user/MyApplication"}>
                                            <Card className="card-bg-color m-2" hoverable bordered>
                                                <div className="d-flex justify-content-between flex-row">
                                                    ...
                                                    <div className="d-flex flex-column align-items-center m-2">
                                                        <h4 className="align-self-start mb-1">Organization Profile</h4>
                                        ...
                                        <Link href={`${baseUrl}${"/promotions-products"}`}>
                                            <Card className="card-bg-color m-2" hoverable bordered>
                                                <div className="d-flex justify-content-between flex-row">
                                                    ...
                                                    <div className="d-flex flex-column align-items-center m-2">
                                                        <h4 className="align-self-start mb-1">Promotions</h4>

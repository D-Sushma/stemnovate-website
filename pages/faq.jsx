                        ...
                        <div
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> How do I order from Stemnovate?
                                </b>
                            </h4>
                            <p
                                style={{
                                ...
                                Products can be ordered directly from our website. Customers will be required to be registered in order to checkout their purchases. Customers who have ordered from us previously will have access to a list of their previous purchases to allow them to quickly & easily place repeat orders if required.
                                <br
                                    style={{
                                        boxSizing: "border-box",
                                        WebkitFontSmoothing: "antialiased",
                                ...
                                and we will be happy to discuss your requirements and provide you with a personalized quotation.
                            </p>
                            <h4
                                style={{
                                    boxSizing: "border-box",
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> I have specialist requirements for a proposed R&D project in my lab, who should I talk to?
                                </b>
                            </h4>
                            <p
                                style={{
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> What types of cells can you provide?
                                </b>
                            </h4>
                            <p
                                style={{
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> Can we buy either frozen or live cells?
                                </b>
                            </h4>
                            <p
                                style={{
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> What do your customers use Stemnovate fibroblasts for?
                                </b>
                            </h4>
                            <p
                                style={{
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> What are induced stem cells (iPSCs)?
                                </b>
                            </h4>
                            <p
                                style={{
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> What are iPSCs used for?
                                </b>
                            </h4>
                            <p
                                style={{
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> What types of cells can iPSCs be differentiated into?
                                </b>
                            </h4>
                            <p
                                style={{
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> Are Stemnovate cells tested for mycoplasma before they are shipped to customers?
                                </b>
                            </h4>
                            <p
                                style={{
                            ...
                            <h4
                                ...
                                <b
                                    ...
                                    <AiFillStar size={30} className="text-color-first" /> Are Stemnovate compliant?
                                </b>
                            </h4>
                            <p
                                style={{

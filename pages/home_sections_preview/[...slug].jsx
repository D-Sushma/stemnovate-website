...
const HomeDefaultPage = (props) => {
  ...
  useEffect(() => {
    console.log('props?.sectionDetails',props?.sectionDetails?.length)
    if(props?.gotoRef == 'promotions'){
      gotoSections(testimonialRef);
    }
    if(props?.gotoRef == 'reviews'){
      gotoSections(testimonialreviewRef);
    }
    if(props?.gotoRef == 'aboutbanner'){
      gotoSections(bannerRef);
    }
    if(props?.gotoRef == 'ourclients'){
      gotoSections(ourclientsRef);
    }
    if(props?.gotoRef == 'ourservices'){
      gotoSections(servicesRef);
    }
  ...
  const testimonialreviewRef = useRef(null)
  const gotoSections = (ref) => {
    if (ref && ref.current) {
      window.scrollTo({
        behavior: "smooth",
  ...
  return (
    ...
    >
      <main id="homepage-one">
        {details?.length > 0 &&
        props.vdoDetails?.data?.length !== 0 &&
        props.vdoDetails?.data?.length !== undefined ? (

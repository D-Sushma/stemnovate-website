        ...
        <div className="ps-block--checkout-order">
            <div className="ps-block__content">
                ...
                <figure className="ps-block__payment-methods">
                    <div className="ps-radio">
                        <input className="form-control" type="radio" id="payment-method-1" name="payment-method" />
                        <label htmlFor="payment-method-1">Direct bank transfer</label>
                    </div>
                    <div className="ps-radio">
                        <input className="form-control" type="radio" id="payment-method-2" name="payment-method" />
            ...
            <div className="ps-block__footer">
                <Link href="/shop/checkout-success">
                    <a className="ps-btn ps-btn--fullwidth ps-btn--black">Process to checkout</a>
                </Link>

...
function BothFormCheckout({ ecomerce, userStatus, UserData }) {
    ...
    const checkAllFelids = () => {
        ...
        if (myBillingdetails?.customer_address_details && myBillingdetails?.customer_address_details?.B_First !== "" && myBillingdetails?.customer_address_details?.B_last !== "" && myBillingdetails?.customer_address_details?.B_Email !== "" && myBillingdetails?.customer_address_details?.B_Country !== "" && myBillingdetails?.customer_address_details?.B_County !== "" && myBillingdetails?.customer_address_details?.B_PhoneNumber !== "" && myBillingdetails?.customer_address_details?.B_Address1 !== "" && myBillingdetails?.customer_address_details?.B_ZIP !== "" && myBillingdetails?.customer_address_details?.B_Town !== "" && myBillingdetails?.customer_address_details?.B_PhoneNumber !== "") {
            return true;
        }
        return false;
    };
        ...
        try {
            if (checkAllFelids()) {
                ...
                if (!checkTnC) {
                    ...
                    toast.warning("Please accept our terms and conditions before proceeding.", {
                        position: "top-right",
                        autoClose: 5000,
                    ...
                    const checkoutSession = await axios.post("/api/payments/checkout_sessions", {
                        item: products,
                                ...
                                <div className="col-sm-12">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            onChange={(val) => {
                                                handleUpdate("customer_address_details", "B_County", val.target.value);
                                            }}
                                            defaultValue={myBillingdetails?.customer_address_details && myBillingdetails?.customer_address_details?.B_County}
                                        />
                                    </div>
                                </div>
                                <div className="col-sm-12">
                                ...
                                <div className="col-sm-12">
                                    <div className="form-group">
                                        ...
                                        <input
                                            ...
                                            onChange={(val) => {
                                                handleUpdate("customer_address_details", "B_Address2", val.target.value);
                                            }}
                                            defaultValue={myBillingdetails?.customer_address_details && myBillingdetails?.customer_address_details?.B_Address2}
                                        />
                                    </div>
                                </div>
                                <div className="col-sm-12">
                    ...
                    <div className="ps-checkout__payment">
                        <div className="check-faq">
                            <div class="form-check">
                                <input className="form-check-input" type="checkbox" onClick={(e) => setCheckTnC(e.target.checked)} checked={checkTnC} id="flexCheckDefault" />
                        ...
                        {UserData && UserData.result.status ? null : (
                            <div className="my-3">
                                {UserData && UserData?.result?.is_verified && UserData?.result?.customer_address_details == null ? (
                                    <div className="alert alert-info" role="alert">
                                        Welcome to Stemnovate! Please complete your profile to get custom pricing.
                                    </div>
                                ) : null}
                                ...
                                {UserData && UserData?.result?.is_verified && UserData?.result?.customer_address_details !== null && UserData?.result?.status == 0 ? (
                                    <div className="alert alert-info" role="alert">
                                        We are reviewing your profile and we will be in touch with you soon.
                                    </div>
                                ) : null}
                            </div>
                        )}

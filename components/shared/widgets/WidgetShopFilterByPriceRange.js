...
const WidgetShopFilterByPriceRange = () => {
    ...
    function handleChangeRange(value) {
        ...
        Router.push(`${process.env.NEXT_BASE_URL}/shop?price_gt=${value[0]}&price_lt=${value[1]}`);
    }
    ...
    return (
        <aside className="widget widget_shop">
            <figure>
                ...
                <Slider range defaultValue={[0, 2000]} max={2000} onAfterChange={(e) => handleChangeRange(e)} />
                <p>
                    Price: ${min} - $ {max}
                </p>
            </figure>

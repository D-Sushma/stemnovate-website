                ...
                <div className=" d-flex justify-content-center">
                    <div className="d-flex flex-grow-1 flex-row flex-wrap justify-content-center">
                        <div className="card card-h-min align-items-center p-1 justify-content-center ">
                            <a href="https://www.rvc.ac.uk/" target={"_blank"} rel="noreferrer">
                        ...
                        <div className="card card-h-min align-items-center p-1 justify-content-center ">
                            <a href="https://www.babraham.ac.uk/" target={"_blank"} rel="noreferrer">
                                <div className="d-flex align-items-center our-client-images">
                        ...
                        <div className="card card-h-min align-items-center p-1 justify-content-center ">
                            <a href="https://www.ed.ac.uk/roslin" target={"_blank"} rel="noreferrer">
                                <div className="d-flex align-items-center our-client-images">
                        ...
                        <div className="card card-h-min align-items-center p-1 justify-content-center ">
                            <a href="https://www.qkine.com/" target={"_blank"} rel="noreferrer">
                                <div className="d-flex align-items-center our-client-images">
                        ...
                        <div className="card card-h-min align-items-center p-1 justify-content-center ">
                            <a href="https://www.unibe.ch/" target={"_blank"} rel="noreferrer">
                                <div className="d-flex align-items-center our-client-images">
                        ...
                        <div className="card card-h-min align-items-center p-1 justify-content-center ">
                            <a href="https://www.cuh.nhs.uk/" target={"_blank"} rel="noreferrer">
                                <div className="d-flex align-items-center our-client-images">

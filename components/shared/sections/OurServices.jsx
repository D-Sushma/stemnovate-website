              ...
              <div>
                <a href="/Applications/Drug-Discovery-Platform">
                  ...
                  <p className="text-left  text-white">
                    We use novel multi-organ modelling to evaluate drug molecule
                    metabolism and toxicity, ensuring better clinical trials and
                    patient safety outcomes. Our projects include Hepatitis
              ...
              <div>
                <a href="/Products">
                  ...
                  <p className="mx-4 text-left text-white">
                    ...
                    offer a multispecies cell platform ensuring quality through
                    advanced profiling & bioinformatics.
                  </p>
                </a>
              ...
              <div>
                <a href="/Services">
                  ...
                  <p className="mx-4 text-left text-black">
                    We are experts in cellular reprogramming and one of the only
                    companies globally with the capability for human and animal
                    reprogramming. We design vectors with an industrial process
                    to generate induced pluripotent stem cells. For industry and
                    academia, we routinely differentiate stem cells into the
                    liver, heart, and neuronal cells.
                  </p>
                </a>
                <div className="button button--yellow">
                  <a href="/Services">
              ...
              <div>
                <a href="/Products">
                  ...
                  <p className="mx-4 text-left text-black">
                    ...
                    physiological alternative to cancer lines and animal models
                    for advanced drug discovery. From 2017 to 2019, our research
                    was co-funded by Innovate UK to develop a liver on chip
                    platform. This million-pound funding resulted in patenting
                    innovation that we aim to launch to market soon.
                  </p>
                </a>
                <div className="button button--yellow">
                  <a href="/Products">

                        ...
                        <div className=" row d-flex my-4 justify-content-center">
                            {ProductData.Products &&
                                ProductData.Products.map((post, key) => (
                                    ...
                                    //     </div>
                                    //     </div>
                                    <div className="col-md-3 mb-3 p-2 d-flex flex-column flex-grow-1" key={key}>
                                        <div className="card d-flex flex-column flex-grow-1 rounded-lg align-items-center p-0 ">
                                            <img src={post.image == null ? `/no-image.png` : `${process.env.AWS_S3BUCKET_URL}${post.image}`} className="rounded" alt={post.category_name} />
                                        ...
                                        <div className=" flex-grow-1 bd-highlight  fw-bold">
                                            ...
                                            {ProductData.ProductsList.map((value, key) => (
                                                <div key={key} className="card">
                                                    <Link href={`/product/${value.product_slug}`} as={`/product/${value.product_slug}`}>
                                                        <a href="">
                                                            <Image loader={myLoader} src={`${process.env.AWS_S3BUCKET_URL}${value?.product_image.split(",")[0]}`} unoptimized={false} alt={value?.product_slug} width="480" height="360" />
                                                        </a>
                                                    </Link>
                                                    ...
                                                    <div className="card-body">
                                                        <div className="d-flex flex-column justify-content-center">
                                                            <div className="d-flex justify-content-center py-3">
                                                                <Link href={`/product/${value.product_slug}`} as={`/product/${value.product_slug}`}>
                                                                    <a className="reference-website">{value && value.CatalogueNumber}</a>
                                                                </Link>
                                                            </div>
                                                            ...
                                                            <div className="d-flex justify-content-center py-3 ">{price(value?.product_details)}</div>
                                                            <div className="card-footer">
                                                                <div className="d-flex justify-content-center py-3 ">
                                                                    <Link href={`/product/${value.product_slug}`} as={`/product/${value.product_slug}`}>
                                                                        <a className=" reference-website">View Details</a>
                                                                    </Link>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div key={key}>
                                                    <div className="d-flex bd-highlight border-bottom ">
                                                        ...
                                                        <div className="p-2 w-10 bd-highlight  text-right font-weight-bold">
                                                            <h5 type="button" data-bs-toggle="collapse" data-bs-target={`#expand${key}`} className="collapsed " aria-expanded="false" aria-controls={`expand${key}`}>
                                                                <span className="help">
                                                                    <span className="expander font-weight-bold"></span>
                                                                    <i className="fa font-weight-bold ml-1" aria-hidden="true"></i>
                                                                </span>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                    <div className="collapse" id={`expand${key}`}>
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div className="p-2 bd-highlight w-15  font-weight-bold">Catalogue Number</div>
                                                                <div className="p-2 bd-highlight w-15  font-weight-bold">Product Unit</div>
                                                                <div className="p-2 bd-highlight w-15  font-weight-bold">Deliver Type</div>
                                                                <div className="p-2 bd-highlight w-15  font-weight-bold">Technical Documents</div>
                                                                <div className="p-2 bd-highlight w-15  font-weight-bold">Availability</div>
                                                                <div className="p-2 bd-highlight w-10  font-weight-bold">Price</div>
                                                                <div className="p-2 bd-highlight w-15  font-weight-bold">Quantity</div>
                                                            </div>
                                                            <div className="d-flex justify-content-around align-items-center">
                                                                ...
                                                                <div className="p-2 bd-highlight w-15  ">{value.product_details && value.product_details.product_unit}</div>
                                                                <div className="p-2 bd-highlight w-15  ">{value.deliver_type}</div>
                                                                <div className="p-2 bd-highlight w-15  ">
                                                                    {session ? (
                                                                        value.Product_details_pdf != "" ? (
                                                                            <Link href={session ? `${process.env.AWS_S3BUCKET_URL}${value.Product_details_pdf}` : "#"} passHref>
                                                                                <a target={session ? "_blank" : null} rel="noopener noreferrer">
                                                                                    <i className="fa fa-download font-weight-bold" aria-hidden="true"></i>
                                                                                </a>
                                                                            </Link>
                                                                        ) : (
                                                                            "-"
                                                                ...
                                                                <div className="p-2 bd-highlight w-15  ">{value.stock}</div>
                                                                <div className="p-2 bd-highlight w-10  ">£{value.product_details && value.product_details.sale_price}</div>
                                                                    ...
                                                                    <div className="d-flex bd-highlight justify-content-around align-items-center">
                                                                        <div className="p-2 bd-highlight ">
                                                                            <Input
                                                                                ...
                                                                                addonBefore={
                                                                                    <span className="w-18" onClick={() => RemoveCart(key)}>
                                                                                        <i
                                                                                ...
                                                                                addonAfter={
                                                                                    <span className="w-18" onClick={() => AddCart(key)}>
                                                                                        <i
                                                                ...
                                                                <div className="p-2  bd-highlight ">
                                                                    {AddtoCart[key] > 0 ? (
                                                                        <Button
                                                                            type="primary"
                                                                            onClick={(e) => {
                                                                                !loading ? handleAddItemToCart(value.id, value.product_details.sale_price, key) : null;
                                                                            }}>
                                                                            Add To Cart
                                                                        </Button>
                                                                    ) : (

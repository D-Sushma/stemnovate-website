            ...
            <ul className="ps-comment__list">
                    ...
                    <div className="ps-review--product">
                        <div className="ps-review__row">
                            <div className="ps-review__avatar">
                                <img src="/static/img/avatar/avatar-review3.jpg" alt="alt" />
                            </div>
                            <div className="ps-review__info">
                                <div className="ps-review__name">Jenna S.</div>
                                <div className="ps-review__date">Aug 12, 2021</div>
                            </div>
                ...
                <li>
                    <div className="ps-review--product">
                        <div className="ps-review__row">
                            <div className="ps-review__avatar">
                                <img src="/static/img/avatar/avatar-review4.jpg" alt="alt" />
                            </div>
                            <div className="ps-review__info">
                    ...
                    <ul className="ps-comment__children">
                        <li>
                            <div className="ps-review--product">
                                <div className="ps-review__row">
                                    <div className="ps-review__avatar">
                                        <img src="/static/img/avatar/avatar-admin.jpg" alt="alt" />
                                    </div>
                                    <div className="ps-review__info">
                                        <div className="ps-review__name">Admin</div>
                        ...
                        <li>
                            <div className="ps-review--product">
                                <div className="ps-review__row">
                                    ...
                                    <div className="ps-review__desc">
                                        <p>Thank you for your reply and help!</p>
                                        <a className="ps-review__reply" href="#">
                                            Reply
                                        </a>
                                    </div>
                ...
                <li>
                    <div className="ps-review--product">
                        <div className="ps-review__row">
                            <div className="ps-review__avatar">
                                <img src="/static/img/avatar/avartar-comment.jpg" alt="alt" />
                            </div>
                            <div className="ps-review__info">
                ...
                <li>
                    <div className="ps-review--product">
                        <div className="ps-review__row">
                            <div className="ps-review__avatar">
                                <img src="/static/img/avatar/avatar-review2.jpg" alt="alt" />
                            </div>
                            <div className="ps-review__info">

    ...
    return (
        <div className="tab-pane fade active show" id="reviews-content" role="tabpanel" aria-labelledby="reviews-tab">
                ...
                <div className="ps-review--product">
                    <div className="ps-review__row">
                        <div className="ps-review__avatar">
                            <img src="/static/img/avatar/avatar-review.jpg" alt="alt" />
                        </div>
            ...
            <div className="ps-form--review">
                ...
                <div className="ps-form__desc">Your email address will not be published. Required fields are marked *</div>
                <form action="do_action" method="post">
                    <div className="row">
                        ...
                        <div className="col-12 text-center">
                            <button className="btn ps-btn ps-btn--warning">Add Review</button>
                        </div>
                    </div>
                </form>
            </div>

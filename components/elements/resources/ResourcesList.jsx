              ...
              <section className="ps-section--block-grid ">
                <div className="ps-section__thumbnail m-1 p-1">
                  <a className="ps-section__image" href="#">
                    <img
                      src={`${process.env.AWS_S3BUCKET_URL}${data.category_image}`}
                      alt={data.cat_name}
                    />
                  </a>
                </div>
                ...
                <div className="container">
                  <div className="row   mt-5" data-columns="4">
                    ...
                    {data.other_resources_category.map((myCat, index) => (
                      <div
                        className="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 mb-3 p-2 d-flex flex-column flex-grow-1"
                        key={index}
                      >
                        <div className=" blur rounded border flex-grow-1">
                          ...
                          <div className="m-4 ">
                            <h2
                              className="card-title h2 text-black font-weight-bold"
                              style={{ color: "#000" }}
                            >
                              {myCat.cat_name}
                            </h2>

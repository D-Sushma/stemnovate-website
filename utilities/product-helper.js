...
export function SPGetProductThumbailImage(product, size) {
    ...
    if (thumbnail) {
        ...
        return (
            <LazyLoad>
                <img className="ps-product__image" src={`${baseUrlProduct}${image}`} alt={product.name} />
            </LazyLoad>
        );
    } else {
        return <img src="/static/img/undefined-product-thumbnail.jpg" alt={product.name} />;
    }
}
    ...
    if (thumbnail) {
        ...
        return (
            <div className="ps-product__thumbnail-images">
                <LazyLoad>
                    <img className="ps-product__image" src={`${baseUrlProduct}${imageFront}`} alt={product.name} />
                </LazyLoad>
                <LazyLoad>
                    <img className="ps-product__image-alt" src={`${baseUrlProduct}${imageBack}`} alt={product.name} />
                </LazyLoad>
            </div>
        );
    } else {
